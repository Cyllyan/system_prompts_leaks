...
| What | Date | Link |
|------|------|------|
| **Claude Cookbooks — agent system prompts** | September 4, 2026 | [Research Lead](Anthropic/Claude%20Cookbooks/research-lead-agent.md) · [Research Subagent](Anthropic/Claude%20Cookbooks/research-subagent.md) · [Citations Agent](Anthropic/Claude%20Cookbooks/citations-agent.md) · [Code Reviewer](Anthropic/Claude%20Cookbooks/code-reviewer-agent.md) · [Financial Analyst](Anthropic/Claude%20Cookbooks/chief-of-staff-financial-analyst.md) · [Recruiter](Anthropic/Claude%20Cookbooks/chief-of-staff-recruiter.md) |
| **Claude Code Remote (Sonnet 5, web/cloud sessions)** | September 4, 2026 | [System prompt](Anthropic/Claude%20Code/claude-code-remote.md) |
...
| Claude Code extras | [Claude Code Remote (web/cloud)](Anthropic/Claude%20Code/claude-code-remote.md) · [Glob tool](Anthropic/Claude%20Code/glob-tool.md) · [Grep tool](Anthropic/Claude%20Code/grep-tool.md) · [Deferred tools](Anthropic/Claude%20Code/deferred-tools.md) · [Docs assistant](Anthropic/Claude%20Code/claude-code-docs-assistant.md) · [Bundled skills](Anthropic/Claude%20Code/bundled-skills/) |
| Claude Cookbooks agents | [Research Lead](Anthropic/Claude%20Cookbooks/research-lead-agent.md) · [Research Subagent](Anthropic/Claude%20Cookbooks/research-subagent.md) · [Citations Agent](Anthropic/Claude%20Cookbooks/citations-agent.md) · [Code Reviewer](Anthropic/Claude%20Cookbooks/code-reviewer-agent.md) · [Financial Analyst](Anthropic/Claude%20Cookbooks/chief-of-staff-financial-analyst.md) · [Recruiter](Anthropic/Claude%20Cookbooks/chief-of-staff-recruiter.md) |
...
| Product | Prompt |
|---------|--------|
| Cursor | [System prompt](Cursor/cursor.md) |
...
| Product | Prompt |
|---------|--------|
| Notion AI | [System prompt](Notion/notion-ai.md) |
